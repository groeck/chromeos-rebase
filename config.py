...
topiclist = [ [ "chromeos", "COMMIT-QUEUE.ini", "PRESUBMIT.cfg"],
	...
	[ "drivers/gpu/drm/rockchip", "drivers/gpu/drm/bridge/analogix", "include/drm/bridge/analogix_dp.h",
	  "Documentation/devicetree/bindings/display/rockchip", "drivers/media/platform/rockchip-vpu",
	  "drivers/media/platform/rk3288", "Documentation/devicetree/bindings/display/rockchip/analogix_dp-rockchip.txt",
