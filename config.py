...
topiclist_consolidated = [
    ...
    ["drm/gpu",
     ["drm/amd", "drm/i915", "drm/mediatek", "drm/qualcomm", "drm/panel", "drm/rockchip",
      "gpu/other", "arm/mali"]],
    ["virt",
     ["drm/virtio", "virtio", "media/virtio", "virt/kvm", "arcvm/container"]],
    ["other",
     ["other", "devicetree", "acpi", "cpufreq", "firmware/google", "devfreq", "block",
      "android", "video", "sysrq", "scheduler", "tools"]],
    ["dts",
     ["dts/arm", "dts/qcom", "dts/mediatek", "dts/rk3399"]],
    ["drivers",
     ["drivers", "iio", "input", "usb", "usb-gadget", "mmc", "mtd", "drivers/mediatek",
      "drivers/rockchip", "iommu", "mfd", "remoteproc", "devfreq", "regulator", "scsi",
      "soundwire"]],
    ["sound",
